<!-- Falta el href desde cualquier lugar dando click a envipropment y envie aqui
además de que muestre los datos que se integren en los txt box  -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body onload="nombuser(), cargarFontusr(),cargartemausr()" id="cuerpo">
    ...
    <main class="main">
        <h2>¡Contactanos!</h2>
        <div class="conten">
            <!-- En toda está zona es donde está la imagen y los datos de la empresa -->
            <article class="empresa">
                <div class="contenedor-img">
                    <img src="img/envipropment.JPG" alt="">
                </div>
            ...
            <form class="formulario">
                <!-- En está parte están los text box y buttons  -->
                <div class="txtcontact">
                    ...
                    <div class="correo">
                        ...
                        <input id="txtcorreo" type="email" name="correo" required/>
                    </div>
                    <textarea id="txtmensaje"name="mensajee" placeholder="Mensaje:" required></textarea>
                </div>
